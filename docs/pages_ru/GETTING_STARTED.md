...
* Для разработчика
  ...
  * Простой пример на shell (наполнение `result/any-any/script.sh`)
...
#### Vault
*TODO: параграф про отступление от официальной документации надо будет убрать, когда запись лога в файл будет убрана по умолчанию*
